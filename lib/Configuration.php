...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://api.ycloud.com/v2';
     ...
     * @var string
     */
    protected $userAgent = 'ycloud-sdk-php/1.15.5';
    ...
    {
        $report  = 'PHP SDK (YCloud\Client) Debug Report:' . PHP_EOL;

...
/**
 * WhatsappMessagesApi Class Doc Comment
 *
 * @category Class
 * @package  YCloud\Client
 * @author   OpenAPI Generator team
...
class WhatsappMessagesApi
{
     ...
     * @return \YCloud\Client\Model\WhatsappMessage|\YCloud\Client\Model\ErrorResponse
     */
     ...
     * @throws \YCloud\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \YCloud\Client\Model\WhatsappMessage|\YCloud\Client\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    public function retrieveRequest($id)
    {
        ...
        $resourcePath = '/whatsapp/messages/{id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     */
    public function send($whatsapp_message_send_request)
    {
        list($response) = $this->sendWithHttpInfo($whatsapp_message_send_request);
        return $response;
    }
     ...
     */
    public function sendWithHttpInfo($whatsapp_message_send_request)
    {
        $request = $this->sendRequest($whatsapp_message_send_request);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function sendAsync($whatsapp_message_send_request)
    {
        return $this->sendAsyncWithHttpInfo($whatsapp_message_send_request)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function sendAsyncWithHttpInfo($whatsapp_message_send_request)
    {
        $returnType = '\YCloud\Client\Model\WhatsappMessage';
        $request = $this->sendRequest($whatsapp_message_send_request);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function sendRequest($whatsapp_message_send_request)
    {
        ...
        if ($whatsapp_message_send_request === null || (is_array($whatsapp_message_send_request) && count($whatsapp_message_send_request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $whatsapp_message_send_request when calling send'
            );
        }

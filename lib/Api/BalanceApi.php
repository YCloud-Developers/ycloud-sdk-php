...
class BalanceApi
{
    ...
    {
        list($response) = $this->retrieveWithHttpInfo();
        return $response;
    }
    ...
    public function retrieveWithHttpInfo()
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\YCloud\Client\Model\Balance' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\YCloud\Client\Model\Balance' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\YCloud\Client\Model\Balance', []),
    ...
    {
        return $this->retrieveAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveAsyncWithHttpInfo()
    {
        $returnType = '\YCloud\Client\Model\Balance';
        $request = $this->retrieveRequest();

...
class Error implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets message
     *
     * @param string|null $message A human-readable representation of the error. It is intended as an aid to developers and is not suitable for exposure to end users.
     *
     * @return self
     */
     ...
     * Sets doc_url
     *
     * @param string|null $doc_url A URL to more information about the error.
     *
     * @return self
     */

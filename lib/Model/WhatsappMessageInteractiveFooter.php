 ...
 *
 * @category Class
 * @description [WhatsApp Footer Object](https://developers.facebook.com/docs/whatsapp/cloud-api/reference/messages#footer-object).
 * @package  YCloud\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class WhatsappMessageInteractiveFooter implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WhatsappMessageInteractive_footer';
     ...
     * Sets text
     *
     * @param string|null $text The footer content. Emojis and markdown are supported. Links are supported.
     *
     * @return self
     */

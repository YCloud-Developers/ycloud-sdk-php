...
/**
 * CustomEventDefinitionProperty Class Doc Comment
 *
 * @category Class
 ...
 */
class CustomEventDefinitionProperty implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CustomEventDefinitionProperty';
     ...
     * Sets name
     *
     * @param string|null $name The name of the custom property.
     *
     * @return self
     */
     ...
     * Sets label
     *
     * @param string|null $label The label of the property, used for display purposes.
     *
     * @return self
     */
    public function setLabel($label)
    {
        if (!is_null($label) && (mb_strlen($label) > 50)) {
            throw new \InvalidArgumentException('invalid length for $label when calling CustomEventDefinitionProperty., must be smaller than or equal to 50.');
        }

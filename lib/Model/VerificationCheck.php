...
/**
 * VerificationCheck Class Doc Comment
 *
 * @category Class
 * @package  YCloud\Client
 * @author   OpenAPI Generator team
 ...
 */
class VerificationCheck implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'VerificationCheck';
     ...
     * Sets valid
     *
     * @param bool $valid Whether the verification code is valid for this check.
     *
     * @return self
     */
     ...
     * Sets to
     *
     * @param string|null $to The recipient's phone number in [E.164](https://en.wikipedia.org/wiki/E.164) format or email address.
     *
     * @return self
     */

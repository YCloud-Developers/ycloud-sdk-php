 ...
 *
 * @category Class
 * @description [WhatsApp Media Object](https://developers.facebook.com/docs/whatsapp/cloud-api/reference/messages#media-object).
 * @package  YCloud\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class WhatsappMessageMedia implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets caption
     *
     * @param string|null $caption Describes the specified `video` or `image` media.
     *
     * @return self
     */

...
class ContactUpdateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setNickname($nickname)
    {
        if (!is_null($nickname) && (mb_strlen($nickname) > 250)) {
            throw new \InvalidArgumentException('invalid length for $nickname when calling ContactUpdateRequest., must be smaller than or equal to 250.');
        }
    ...
    public function setEmail($email)
    {
        if (!is_null($email) && (mb_strlen($email) > 250)) {
            throw new \InvalidArgumentException('invalid length for $email when calling ContactUpdateRequest., must be smaller than or equal to 250.');
        }
     ...
     * Sets tags
     *
     * @param string[]|null $tags Contact's tags. Maximum items: 50.
     *
     * @return self
     */
    public function setTags($tags)
    {
        ...
        if (!is_null($tags) && (count($tags) > 50)) {
            throw new \InvalidArgumentException('invalid value for $tags when calling ContactUpdateRequest., number of items must be less than or equal to 50.');
        }
     ...
     *
     * @param \YCloud\Client\Model\ContactCreateRequestCustomAttributesInner[]|null $custom_attributes Contact's custom attributes. If present (i.e., not `null`), all previous attributes of this contact will be replaced.
     *
     * @return self
     */

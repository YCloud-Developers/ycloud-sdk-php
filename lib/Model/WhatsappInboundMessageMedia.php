...
class WhatsappInboundMessageMedia implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WhatsappInboundMessageMedia';
     ...
     * Sets caption
     *
     * @param string|null $caption The provided caption for the media. Only present if specified.
     *
     * @return self
     */
     ...
     * Sets filename
     *
     * @param string|null $filename Filename on the sender's device. This will only be present in `document` media messages.
     *
     * @return self
     */
     ...
     * Sets mime_type
     *
     * @param string|null $mime_type Mime type of the media.
     *
     * @return self
     */

...
class WhatsappMessageTemplateComponent implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets sub_type
     *
     * @param string|null $sub_type **Required when type is `button`.** Type of button to create. `quick_reply`: Refers to a previously created quick reply button that allows for the customer to return a predefined message. `url`: Refers to a previously created button that allows the customer to visit the URL generated by appending the text parameter to the predefined prefix URL in the template.
     *
     * @return self
     */
    ...
    public function setIndex($index)
    {
        ...
        if (!is_null($index) && ($index > 2)) {
            throw new \InvalidArgumentException('invalid value for $index when calling WhatsappMessageTemplateComponent., must be smaller than or equal to 2.');
        }

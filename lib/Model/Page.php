...
class Page implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setOffset($offset)
    {
        ...
        if (($offset < 0)) {
            throw new \InvalidArgumentException('invalid value for $offset when calling Page., must be bigger than or equal to 0.');
        }
    ...
    public function setLimit($limit)
    {
        ...
        if (($limit < 1)) {
            throw new \InvalidArgumentException('invalid value for $limit when calling Page., must be bigger than or equal to 1.');
        }
    ...
    public function setLength($length)
    {
        ...
        if (($length < 0)) {
            throw new \InvalidArgumentException('invalid value for $length when calling Page., must be bigger than or equal to 0.');
        }
    ...
    public function setTotal($total)
    {
        ...
        if (!is_null($total) && ($total < 0)) {
            throw new \InvalidArgumentException('invalid value for $total when calling Page., must be bigger than or equal to 0.');
        }

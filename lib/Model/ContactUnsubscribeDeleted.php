...
/**
 * ContactUnsubscribeDeleted Class Doc Comment
 *
 * @category Class
 ...
 */
class ContactUnsubscribeDeleted implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ContactUnsubscribeDeleted';
     ...
     * Sets update_time
     *
     * @param \DateTime|null $update_time The time when customers cancel unsubscribe, formatted in [RFC 3339](https://datatracker.ietf.org/doc/html/rfc3339). e.g., `2022-06-01T12:00:00.000Z`.
     *
     * @return self
     */

...
**package_name** | **string** | **Deprecated since 2025-07-23. Use &#x60;supported_apps&#x60; instead.** **One-tap and zero-tap buttons only.** Your Android app&#39;s package name. | [optional]
**signature_hash** | **string** | **Deprecated since 2025-07-23. Use &#x60;supported_apps&#x60; instead.** **One-tap and zero-tap buttons only.** Your app signing key hash. See [App Signing Key Hash](https://developers.facebook.com/docs/whatsapp/business-management-api/authentication-templates/zero-tap-authentication-templates#app-signing-key-hash). | [optional]
**supported_apps** | [**\YCloud\Client\Model\WhatsappTemplateComponentButtonOtpSupportedApp[]**](WhatsappTemplateComponentButtonOtpSupportedApp.md) | **One-tap and zero-tap buttons only.** List of supported apps. | [optional]
